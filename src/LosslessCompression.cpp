...
namespace
{
	...
	struct CompressionHeader
	{
		...
		LosslessCoompressionLevel CompLevel{ LosslessCoompressionLevel::Fast };
...
std::vector<uint8_t> CR::DataCompression::Compress(const void* a_src, uint32_t a_srcSize,
	LosslessCoompressionLevel a_level)
{
	...
	switch (a_level)
	{
	case LosslessCoompressionLevel::Fast:
		bound = LZ4_compressBound((int)a_srcSize);
		break;
	case LosslessCoompressionLevel::Mixed:
		bound = LZ4_compressBound((int)a_srcSize);
		break;
